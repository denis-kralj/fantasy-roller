...
function peg$parse(input, options) {
  ...
  var peg$f0 = function(firstOperand, rest) {
      return mergeResults(firstOperand, rest);
    };
  var peg$f1 = function(operator, nextOperand) {
      validateOperand(nextOperand);
      return { operator, nextOperand };
    };
  var peg$f2 = function(operator) { return operator; };
  var peg$f3 = function(count, sides) {
        return rollDice(count, sides);
      };
  var peg$f4 = function(integer) {
        return {
          result: integer,
          rolls: []
        };
  ...
  function peg$parseexpressionRest() {
    var s0, s1, s2, s3, s4;
